          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              ...
              <li className="flex gap-3">
                ...
                <a href="tel:0977457676" className="hover:text-primary-400 transition-colors">0977.457.676</a>
              </li>
              <li className="flex gap-3">
                <svg className="w-4 h-4 text-primary-400 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:phanviethungtk@gmail.com" className="hover:text-primary-400 transition-colors">phanviethungtk@gmail.com</a>
              </li>
              <li className="flex gap-3">
                <svg className="w-4 h-4 text-primary-400 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
