    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="bg-gradient-to-r from-primary-700 via-primary-600 to-indigo-600 text-white overflow-hidden"
        >
          <div className="max-w-7xl mx-auto px-4 py-2 flex items-center justify-center gap-3 text-sm">
            <span className="hidden sm:flex items-center gap-1.5">
              <span className="inline-block w-2 h-2 bg-amber-400 rounded-full animate-pulse" />
              <span className="font-semibold">Ưu đãi tháng 4:</span>
            </span>
            <span className="text-blue-50">Miễn phí tháng đầu khi đăng ký gói Chuyên Nghiệp trở lên</span>
            <Link
              to="/lien-he"
